...
| `case-workflow-mri.html` | Flagship workflow diagnostic, generated bundle, governance, and evals case study |
...
| File | Source / Safety |
|---|---|
| `media/workflow-mri-workbench.png` | Captured from the generated Workflow MRI Meridian Claims bundle with Safe Mode ON and fictional data only |
...
- Workflow MRI embedded demo includes the generated Meridian Claims bundle, audit trail, eval-backed proof points, and Safe Mode redaction.
